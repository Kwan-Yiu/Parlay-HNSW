...
// template <class E>
// struct maxF { E operator() (const E& a, const E& b) const {return (a>b) ? a :
// b;}};

// template <class E>
// struct minF { E operator() (const E& a, const E& b) const {return (a<b) ? a :
// b;}};
...
//     if (In == Out)
//       return
//       pbbs::scan_inplace(pbbs::range<ET*>(In,In+n),pbbs::make_monoid(f,zero));
//     else {
